...
parser.add_argument('--exp', type=str,
                    default='ACDC/pCE_scribble2label_ViT', help='experiment_name')
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % args.period_iter == 0:
                ...
                for idx, images in ds.images.items():
                    img = images['image']
                    img = zoom(
                        img, (224 / img.shape[0], 224 / img.shape[1]), order=0)
                    ...
                    pred = zoom(
                        pred, (1, images['image'].shape[0] / 224, images['image'].shape[1] / 224), order=0)
