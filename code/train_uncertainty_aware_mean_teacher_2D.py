...
parser.add_argument('--exp', type=str,
                    default='robotic/Uncertainty_Aware_Mean_Teacher', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    db_train_labeled = BaseDataSets(base_dir=args.root_path, num=4, labeled_type="labeled", split="train", transform=transforms.Compose([
        RandomGenerator(args.patch_size)
    ]))
    db_train_unlabeled = BaseDataSets(base_dir=args.root_path, num=4, labeled_type="unlabeled", split="train", transform=transforms.Compose([
        RandomGenerator(args.patch_size)]))
